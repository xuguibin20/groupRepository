/*!
 * bpmn-js - bpmn-navigated-viewer v3.2.2
 *
...
(function (global, factory) {
	...
	function BpmnRenderer(
	  ...
	  // MODIFY:自定义图元右上角角标路径
	  function createMark(parentGfx, element, text, color) {
		  if (text) {
	    	  var pathData = "M57.347-6959l13.128,12.835v22.146L35.068-6959Z";
		      drawPath(parentGfx, pathData, {
		        strokeWidth: 3,
		        fill: color,
		        stroke: color,
		        transform: "translate(29 6959.532)"
		      });
		      
		      // MODIFY:通过、待办、回退及撤回等文字
		      renderLabel(parentGfx, text, {
			      box: element,
			      align: "right-top",
			      padding: 5,
			      style: {
			    	"transform": "translate(43.5 -48.5) rotate(45)",
			        "fill": "#fff",
			        "font-size":"10px",
	  ...
	  // MODIFY:设置填充色
	  function setBiocFill(element, defaultFillColor) {
    	  var fillColor = getFillColor(element, defaultFillColor);
	      var fillColorArr = fillColor.split("-");
	      var markColor = "";
	      if (fillColorArr.length > 1) {
	    	  getDi(element).set('bioc:fill', fillColorArr[0])
	      }
      }
	  ...
	  var handlers = this.handlers = {
	    ...
	    'bpmn:ServiceTask': function(parentGfx, element) {
    	  // MODIFY:处理待办、已办、回退及撤回等图元填充色、描边色及角标填充色
	      var text = "";
	      var fillColor = getFillColor(element, defaultFillColor);
	      var fillColorArr = fillColor.split("-");
	      var markColor = "";
	      ...
	      // MODIFY: ‘通过’右上角角标
	      /* service mark */ createMark(parentGfx, element, text, markColor);
	      return task;
	    },
	    'bpmn:UserTask': function(parentGfx, element) {
	      ...
	      // MODIFY:路径4 待办、已办、回退及撤回等右上角角标
	      /* user4 path */ createMark(parentGfx, element, text, markColor);
	    ...
	    'bpmn:OptionalGateway': function(parentGfx, element) {
	    	  // MODIFY
		      var fillColor = getFillColor(element, defaultFillColor);
		      setBiocFill(element, fillColor);
		      var diamond = renderer('bpmn:Gateway')(parentGfx, element);
		      ...
		      var pathData = pathMap.getScaledPath('GATEWAY_OPTIONAL', {
		          xScaleFactor: 0.3,
		          yScaleFactor:0.3,
		          containerWidth: element.width,
		          containerHeight: element.height,
		        ...
		        /* line path */ drawPath(parentGfx, pathData, {
		          strokeWidth: 1,
		          fill: getStrokeColor(element, defaultStrokeColor),
		          stroke: getStrokeColor(element, defaultStrokeColor)
		        });
...
//	      }
	...
	Text.prototype.layoutText = function(text, options) {
	  ...
	  forEach(layouted, function(line) {
	    ...
	    attr$1(tspan, { x: x, y: y, title: line.text });
	...
	function PathMap() {
	  ...
	  this.pathMap = {
	    ...
	    'GATEWAY_OPTIONAL': {
	        d:'m {mx},{my} 0,{e.y0} {e.x0},0 0,-{e.y0} -{e.x0},0 z',
	        height: 30,
	        width:  30,
	        heightElements: [3],
	        widthElements: [70]
