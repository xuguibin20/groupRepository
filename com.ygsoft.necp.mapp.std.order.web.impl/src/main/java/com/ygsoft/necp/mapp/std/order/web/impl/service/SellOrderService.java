...
import com.ygsoft.necp.mapp.std.order.web.service.service.ISellOrderService;
import com.ygsoft.necp.mapp.std.order.web.service.context.ISellOrderContext;

/**
 * SellOrderService服务类.<br>
 *
 * @author 04192213 <br>
 ...
 */
@RestController
@RequestMapping("/necp/mapp/order/service/sellOrder")
public class SellOrderService extends GenEntityService<SellOrder, ISellOrderContext>
		implements ISellOrderService {
}
